                                ...
                                error : (NSError **) error
{
    ...
    if ( status != noErr )
    {
        if ( status == errSecItemNotFound )
        {
            ...
            // Users of this API will probably want to detect this error and prompt the user to re-enter their credentials.
            // When you attempt to store the re-entered credentials
            // using storeUsername:andPassword:forServiceName:updateExisting:error
            // the old, incorrect entry will be deleted and a new one with a properly encrypted password will be added.
...

{
    ...
    {
        // No existing entry (or an existing, improperly entered, and therefore now deleted, entry).
        // Create a new entry.
        NSArray *keys = [[NSArray alloc] initWithObjects : (__bridge_transfer NSString *) kSecClass,
                                                           kSecAttrService, kSecAttrLabel, kSecAttrAccount, kSecValueData, nil];
