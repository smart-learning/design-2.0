...
@interface IFPlayListPopupView () < UITableViewDelegate, UITableViewDataSource, IFPlayListPopupViewCellDelegate >
{
    UIView *contentView;
...
@implementation IFPlayListPopupView
          ...
          cellForRowAtIndexPath: (NSIndexPath *) indexPath
{
    ...
    IFPlayListPopupViewCell *cell;
    cell = [tableView dequeueReusableCellWithIdentifier: identifier];
    
    if ( cell == nil )
    {
        cell = [[IFPlayListPopupViewCell alloc] initWithStyle: UITableViewCellStyleDefault
...
#pragma mark - IFPlayListPopupViewCellDelegate
                 ...
                 selectedIndex: (NSInteger) index
{
    ...
    for ( IFPlayListPopupViewCell *cell in cells )
    {
