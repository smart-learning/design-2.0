...
export default class CircularCarousel extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      dataSource: [
        {
          url: 'http://static.welaaa.co.kr/static/cbanner/series_036.jpg'
        },
        {
          url: 'https://static.welaaa.co.kr/static/cbanner/series_035.jpg'
        },
        {
          url: 'http://static.welaaa.co.kr/static/cbanner/series_2.jpg'
        },
        {
          url: 'http://static.welaaa.co.kr/static/cbanner/series_4.jpg'
        },
        {
          url: 'http://static.welaaa.co.kr/static/cbanner/series_6.jpg'
        },
        {
          url: 'http://static.welaaa.co.kr/static/cbanner/series_7.jpg'
        },
        {
          url: 'http://static.welaaa.co.kr/static/cbanner/series_3.jpg'
        }
      ],
      radius: 12,
      itemWidth: 270,
  ...
  initAnimateValue() {
    ...
    this.selectedML = new Animated.Value(
      (this.state.containerWidth - 200) * 0.5
    );
  ...
  render() {
    ...
    return (
      ...
      >
        {this.state.sortedItemsDepth.map(
          (data, index) =>
            this.renderItem(
    ...
    this.panResponder = PanResponder.create({
      ...
      onPanResponderRelease: (e, gestureState) => {
        ...
        if (gestureState.dx < 3) {
          let dis = Math.abs(
            e.nativeEvent.pageX - (this.state.containerWidth + 20) / 2
          );
          if (dis < this.state.itemWidth / 2)
            this.itemPressed(this.getFrontItem());
        }
      }
    });
  }
  ...
  rotateCarousel(item) {
    ...
    if (rotationAngle > 180) rotationAngle = rotationAngle - 360; // make angle negative
