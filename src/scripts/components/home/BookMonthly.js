...
class BookMonthly extends React.Component {
  ...
  handleBackPress = () => {
    ...
    if (this.props.navigation.isFocused()) {
      if (globalStore.prevLocations.length === 0) this.props.location.goBack();
      else this.props.navigation.navigate(globalStore.prevLocations.pop());
    }
                    ...
                    >
                      <View style={styles.bookItem}>
                        <View style={styles.bookThumbnailContainer}>
                          <ImageBackground
                            source={{
                              uri: item.book_a.audiobook.images.cover
                            }}
                            resizeMode={'cover'}
                    ...
                    >
                      <View style={styles.bookItem}>
                        <View style={styles.bookThumbnailContainer}>
                          <ImageBackground
                            source={{
                              uri: item.book_b.audiobook.images.cover
                            }}
                            resizeMode={'cover'}
                            style={styles.thumbnail}
                          />
