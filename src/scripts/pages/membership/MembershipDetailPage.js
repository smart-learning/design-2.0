						...
						<View style={styles.tabContainer}>
							<TouchableOpacity activeOpacity={0.9} onPress={() => {this.tabStatus = 'premium'}}>
								<View style={this.tabStatus === 'premium' ? styles.tabItemActive : styles.tabItem}>
									<Text style={this.tabStatus === 'premium' ? styles.tabItemTextActive : styles.tabItemText}>프리미엄캠퍼스</Text>
								</View>
							</TouchableOpacity>
						</View>
						<View style={styles.tabContainer}>
					...
					<View>
						...
						<View style={styles.sectionList}>
							<View style={styles.sectionListItem}>
								<View style={styles.sectionListItemBullet} borderRadius={3}/>
								<Text style={styles.sectionListItemText}>
									리딩멘토 추천 이달의 책 1권, 선택일로부터 60일 동안 무료 이용
								</Text>
							</View>
							<View style={styles.sectionListItem}>
								<View style={styles.sectionListItemBullet} borderRadius={3}/>
								<Text style={styles.sectionListItemText}>
									윌라 인기 오디오북 1권, 선택일로부터 60일 동안 무료 이용
								</Text>
							</View>
							<View style={styles.sectionListItem}>
								<View style={styles.sectionListItemBullet} borderRadius={3}/>
								<Text style={styles.sectionListItemText}>
									마음에 드는 책이 없으면 위 2개의 이용권 모두 무한 이월 가능
								</Text>
							</View>
							<View style={styles.sectionListItem}>
								<View style={styles.sectionListItemBullet} borderRadius={3}/>
						...
						<View style={styles.sectionList}>
							<View style={styles.sectionListItem}>
								<View style={styles.sectionListItemBullet} borderRadius={3}/>
								<Text style={styles.sectionListItemText}>
									윌라 멤버십에 <Text style={styles.sectionListItemTextImportant}>가입 즉시</Text> 멤버십 권한이 시작됩니다.
								</Text>
							</View>
							<View style={styles.sectionListItem}>
								<View style={styles.sectionListItemBullet} borderRadius={3}/>
								<Text style={styles.sectionListItemText}>
									단, 각종 쿠폰/이벤트 등을 통해
									<Text style={styles.sectionListItemTextImportant}>이미 이용 중인 무료 멤버십이 있으면, 해당 멤버십 기간 종료 후</Text>
									유료 멤버십이 시작됩니다.
								</Text>
							</View>
							<View style={styles.sectionListItem}>
								...
								<Text style={styles.sectionListItemText}>
									윌라 멤버십은 ‘월 단위’로
									<Text style={styles.sectionListItemTextImportant}>매월 가입일에 권한이 새롭게 갱신</Text>
									됩니다.
								</Text>
							</View>
						</View>
						...
						<View style={styles.sectionList}>
							<View style={styles.sectionListItem}>
								...
								<Text style={styles.sectionListItemText}>
									멤버십 회비는
									<Text style={styles.sectionListItemTextImportant}>매월 가입일에 입력하신 결제 정보</Text>
									를 통해 자동으로 결제됩니다.
								</Text>
							</View>
							<View style={styles.sectionListItem}>
								...
								<Text style={styles.sectionListItemText}>
									현재는 윌라 런칭기념
									<Text style={styles.sectionListItemTextImportant}>첫 달 무료</Text>
									이벤트 진행 중으로
									첫 달은 무료,
									<Text style={styles.sectionListItemTextImportant}>첫 결제는 다음달 가입일</Text>
									부터 시작됩니다.
								</Text>
							</View>
						</View>
						...
						<View style={styles.sectionList}>
							<View style={styles.sectionListItem}>
								<View style={styles.sectionListItemBullet} borderRadius={3}/>
								<Text style={styles.sectionListItemText}>
									멤버십 변경 신청을 하시면 이미 가입된 멤버십 기간이 종료 된 후에 새로운 멤버십이 적용됩니다.
								</Text>
							</View>
							<View style={styles.sectionListItem}>
								<View style={styles.sectionListItemBullet} borderRadius={3}/>
								<Text style={styles.sectionListItemText}>
									즉시 멤버십 변경을 원하시는 경우는 기존 멤버십을 해지 하신 후 신규 가입 하셔야 합니다. 중간에 멤버십을 해지하시면 환불은 되지 않으니 신중하게 결정해 주세요. ^^
								</Text>
							</View>
						</View>
						...
						<View style={styles.sectionList}>
							<View style={styles.sectionListItem}>
								...
								<Text style={styles.sectionListItemText}>
									윌라 멤버십은
									<Text style={styles.sectionListItemTextImportant}>무약정</Text>
									입니다.
								</Text>
							</View>
							<View style={styles.sectionListItem}>
								...
								<Text style={styles.sectionListItemText}>
									윌라 멤버십 해지는
									<Text style={styles.sectionListItemTextImportant}>‘멤버십 해지’ 버튼을 통해 원클릭으로 가능</Text>
									합니다.
								</Text>
							</View>
							<View style={styles.sectionListItem}>
								<View style={styles.sectionListItemBullet} borderRadius={3}/>
								<Text style={styles.sectionListItemText}>
									멤버십 해지가 윌라 회원 탈퇴를 의미하는 것은 아닙니다. 회원 탈퇴는
						...
						<View style={styles.sectionList}>
							<View style={styles.sectionListItem}>
								<View style={styles.sectionListItemBullet} borderRadius={3}/>
								<Text style={styles.sectionListItemText}>
									오늘 해지해도 멤버십 기간이 남아 있으면
									<Text style={styles.sectionListItemTextImportant}>해당 월 멤버십 마지막날 자정까지</Text>
									동영상 강좌를 이용할 수 있습니다.
								</Text>
							</View>
							<View style={styles.sectionListItem}>
								<View style={styles.sectionListItemBullet} borderRadius={3}/>
								<Text style={styles.sectionListItemText}>
									멤버십 해지 이후에도 개별 구매한 콘텐츠, 무료 콘텐츠 등을 계속 이용할 수 있습니다.
								</Text>
							</View>
						</View>
						<Text style={styles.sectionSubTitle}>(오디오북)</Text>
						<View style={styles.sectionList}>
							<View style={styles.sectionListItem}>
								<View style={styles.sectionListItemBullet} borderRadius={3}/>
								<Text style={styles.sectionListItemText}>
									멤버십 해지 이후에도 이용 기간이 남아 있는 오디오북은 해당 이용일 마지막 날 자정까지 이용할 수 있습니다.
								</Text>
							</View>
							<View style={styles.sectionListItem}>
								<View style={styles.sectionListItemBullet} borderRadius={3}/>
								<Text style={styles.sectionListItemText}>
									아직 사용하지 않은 오디오북 이용권은 멤버십 해지 후에도 사라지지 않으며, 윌라 회원 탈퇴 전까지 언제든 이용할 수 있습니다.
								</Text>
							</View>
						</View>
						...
						<View style={styles.sectionList}>
							...
							<View style={styles.sectionListItem}>
								...
								<Text style={styles.sectionListItemText}>
									결제일로부터
									<Text style={styles.sectionListItemTextImportant}>7일 이내</Text>
									이고,
									<Text style={styles.sectionListItemTextImportant}>콘텐츠 이용 내역이 전혀 없으면</Text>
									즉시 환불 조치 해드립니다.^^
								</Text>
							</View>
						</View>
					...
					<View>
						...
						<View style={styles.sectionList}>
							<View style={styles.sectionListItem}>
								...
								<Text style={styles.sectionListItemText}>
									윌라 멤버십에
									<Text style={styles.sectionListItemTextImportant}>가입 즉시</Text>
									멤버십 권한이 시작됩니다.
								</Text>
							</View>
							<View style={styles.sectionListItem}>
								<View style={styles.sectionListItemBullet} borderRadius={3}/>
								<Text style={styles.sectionListItemText}>
									단, 각종 쿠폰/이벤트 등을 통해 이미
									<Text style={styles.sectionListItemTextImportant}>이용 중인 무료 멤버십이 있으면, 해당 멤버십 기간 종료 후</Text>
									유료 멤버십이 시작됩니다.
								</Text>
							</View>
							<View style={styles.sectionListItem}>
						...
						<View style={styles.sectionList}>
							...
							<View style={styles.sectionListItem}>
								...
								<Text style={styles.sectionListItemText}>
									윌라 멤버십 해지는
									<Text style={styles.sectionListItemTextImportant}>‘멤버십 해지’ 버튼을 통해 원클릭으로</Text>
									가능합니다.
								</Text>
							</View>
							<View style={styles.sectionListItem}>
