...
export default class MembershipDetailPage extends React.Component {
  ...
  constructor(props) {
    super(props);
    this.props.navigation.setParams({ title: '멤버쉽 상세보기' });
  }
      ...
      >
        <ScrollView style={{ width: '100%' }}>
          ...
          <View style={CommonStyles.contentContainer}>
            <View
              style={CommonStyles.alignJustifyContentBetween}
              borderRadius={4}
            >
              ...
              <View>
                ...
                <View style={styles.sectionList}>
                  <View style={styles.sectionListItem}>
                    <View
                      style={styles.sectionListItemBullet}
                      borderRadius={3}
                    />
                ...
                <View style={styles.sectionList}>
                  <View style={styles.sectionListItem}>
                    ...
                    />
                    <Text style={styles.sectionListItemText}>
                      리딩멘토 추천 이달의 책 1권, 선택일로부터 60일 동안 무료
                      이용
                    </Text>
                  </View>
                  <View style={styles.sectionListItem}>
                  ...
                  <View style={styles.sectionListItem}>
                    ...
                    />
                    <Text style={styles.sectionListItemText}>
                      마음에 드는 책이 없으면 위 2개의 이용권 모두 무한 이월
                      가능
                    </Text>
                  </View>
                  <View style={styles.sectionListItem}>
                    ...
                    />
                    <Text style={styles.sectionListItemText}>
                      2권 선택하고 또 듣고 싶으면 30% 할인된 가격으로 추가 구매
                      가능(일부 도서 제외)
                    </Text>
                  </View>
                </View>
                ...
                <View style={styles.sectionList}>
                  <View style={styles.sectionListItem}>
                    ...
                    <Text style={styles.sectionListItemText}>
                      윌라 멤버십에{' '}
                      <Text style={styles.sectionListItemTextImportant}>
                        가입 즉시
                      </Text>{' '}
                      멤버십 권한이 시작됩니다.
                    </Text>
                  ...
                  <View style={styles.sectionListItem}>
                    ...
                    <Text style={styles.sectionListItemText}>
                      단, 각종 쿠폰/이벤트 등을 통해{' '}
                      <Text style={styles.sectionListItemTextImportant}>
                        이미 이용 중인 무료 멤버십이 있으면, 해당 멤버십 기간
                        종료 후
                      </Text>{' '}
                      유료 멤버십이 시작됩니다.
                    </Text>
                ...
                <View style={styles.sectionList}>
                  <View style={styles.sectionListItem}>
                    ...
                    />
                    <Text style={styles.sectionListItemText}>
                      멤버십 변경 신청을 하시면 이미 가입된 멤버십 기간이 종료
                      된 후에 새로운 멤버십이 적용됩니다.
                    </Text>
                  </View>
                  <View style={styles.sectionListItem}>
                    ...
                    />
                    <Text style={styles.sectionListItemText}>
                      즉시 멤버십 변경을 원하시는 경우는 기존 멤버십을 해지 하신
                      후 신규 가입 하셔야 합니다. 중간에 멤버십을 해지하시면
                      환불은 되지 않으니 신중하게 결정해 주세요. ^^
                    </Text>
                  </View>
                </View>
                ...
                <View style={styles.sectionList}>
                  ...
                  <View style={styles.sectionListItem}>
                    ...
                    />
                    <Text style={styles.sectionListItemText}>
                      멤버십 해지가 윌라 회원 탈퇴를 의미하는 것은 아닙니다.
                      회원 탈퇴는{' '}
                      <Text style={styles.sectionListItemTextImportant}>
                        1:1문의
                      </Text>
                ...
                <View style={styles.sectionList}>
                  ...
                  <View style={styles.sectionListItem}>
                    ...
                    />
                    <Text style={styles.sectionListItemText}>
                      멤버십 해지 이후에도 개별 구매한 콘텐츠, 무료 콘텐츠 등을
                      계속 이용할 수 있습니다.
                    </Text>
                  </View>
                </View>
                ...
                <View style={styles.sectionList}>
                  <View style={styles.sectionListItem}>
                    ...
                    />
                    <Text style={styles.sectionListItemText}>
                      멤버십 해지 이후에도 이용 기간이 남아 있는 오디오북은 해당
                      이용일 마지막 날 자정까지 이용할 수 있습니다.
                    </Text>
                  </View>
                  <View style={styles.sectionListItem}>
                    <View
                    ...
                    />
                    <Text style={styles.sectionListItemText}>
                      아직 사용하지 않은 오디오북 이용권은 멤버십 해지 후에도
                      사라지지 않으며, 윌라 회원 탈퇴 전까지 언제든 이용할 수
                      있습니다.
                    </Text>
                  </View>
                </View>
