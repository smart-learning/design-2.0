...
//                        contextWrapper.startService(service);
                  ...
                  sendDataDownload(
                      WELEARN_WEB_URL + "play/play-data/" + mWebPlayerInfo.getCkey()[i] , mWebPlayerInfo.getCkey()[i] );
...
//        });
  ...
  private void sendDataDownload(String sendUrl , String cid) {
    ...
    LogHelper.e(TAG, " sendDataDownload requestWebUrl is " + Preferences.getWelaaaOauthToken(getCurrentActivity()));
