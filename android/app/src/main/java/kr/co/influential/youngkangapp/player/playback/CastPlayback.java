...
import kr.co.influential.youngkangapp.player.utils.MediaIDHelper;
...
public class CastPlayback implements Playback {
  ...
  /**
   * Helper method to convert a {@link android.media.MediaMetadata} to a {@link
  ...
  private static MediaInfo toCastMediaMetadata(MediaMetadataCompat track,
    ...
    return new MediaInfo.Builder(track.getString("__SOURCE__"))
