...
public class PlayerListSameCategoryAdapter extends BaseAdapter {
	private final String TAG = "PlayerSameCategoryAdapter";
	...
	public PlayerListSameCategoryAdapter(Context context, PlayerActivity controller){
