package kr.co.influential.youngkangapp.player.notification;
...
public class MediaNotificationManager extends BroadcastReceiver {
  ...
  private static final String CHANNEL_ID = "kr.co.influential.youngkangapp.MEDIA_CHANNEL_ID";

  private static final int NOTIFICATION_ID = 412;
  private static final int REQUEST_CODE = 100;

  public static final String ACTION_PAUSE = "kr.co.influential.youngkangapp.pause";
  public static final String ACTION_PLAY = "kr.co.influential.youngkangapp.play";
  public static final String ACTION_STOP = "kr.co.influential.youngkangapp.stop";
  public static final String ACTION_STOP_CASTING = "kr.co.influential.youngkangapp.stop_cast";
