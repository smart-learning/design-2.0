...
public class CarHelper {
   ...
   *
   * - connection: when the phone is projecting and at the moment the app is selected from the list
   * of media apps - disconnection: when another media app is selected from the list of media apps
   * or when the phone stops projecting (when the user unplugs it, for example)
   *
   * The actual event (connected or disconnected) will come as an Intent extra, with the key
