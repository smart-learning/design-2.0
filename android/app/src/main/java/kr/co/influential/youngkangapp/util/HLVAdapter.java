...
public class HLVAdapter extends RecyclerView.Adapter<HLVAdapter.ViewHolder> {
    ...
    public HLVAdapter(Context context, PlayerActivity welaaaPlayer , ArrayList<String> groupTitle, ArrayList<String> alImage ,
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        ...
        try{
            ...
            if(timesplitTotalTime[0].equals("00")){
                ...
                viewHolder.grid_item_total_time.setText(timesplitTotalTime[1] + ":" + timesplitTotalTime[2]);
            }else{
