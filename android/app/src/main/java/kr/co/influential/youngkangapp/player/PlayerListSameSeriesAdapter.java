...
//						}
  ...
  public void add(String _msg1, String _msg2, String _msg3, String _msg4, String _msg5,
      String _msg6, String _msg7) {
  ...
  public void remove(int _position1, int _position2, int _position3, int _position4, int _position5,
      int _position6, int _position7) {
