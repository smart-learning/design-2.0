...
import static com.welaaav2.player.utils.MediaIDHelper.MEDIA_ID_MUSICS_BY_SEARCH;
...
import com.welaaav2.player.VoiceSearchParams;
...
public class QueueHelper {
   ...
   */
  public static List<MediaSessionCompat.QueueItem> getRandomQueue() {
    List<MediaMetadataCompat> result = new ArrayList<>(RANDOM_QUEUE_SIZE);
    Iterable<MediaMetadataCompat> shuffled = Collections.emptyList();
